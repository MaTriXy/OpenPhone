...
public final class OpenAiResponsesAgentAdapter implements ModelAdapter {
    ...
    private JSONObject callOrchestratorResponsesApi(String userMessage, boolean hasActiveTask,
        ...
        String conversation = recentConversationJson == null
        ...
        String prompt = "You are the OpenPhone orchestrator: the single decision point for "
                ...
                + "- retrieve: answer using on-device data via ONE read-only tool call in "
                + "proposed_actions (notifications, messages, calendar, contacts, calls, "
                + "memories, commitments, watchers, context). Example: \"what did I miss?\" -> "
                ...
                + "if...\"). Use watcher_create or a commitment tool in proposed_actions. For "
                ...
                + "when the user wants a reminder only if no reply arrives in time.\n"
                + "- memory: the user wants something remembered or recalled. Use memory_save "
                + "or memory_search in proposed_actions.\n"
