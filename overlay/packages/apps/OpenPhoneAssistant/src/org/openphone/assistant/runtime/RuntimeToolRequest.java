...
public final class RuntimeToolRequest {
    private final String mRequestId;
    private final String mRuntime;
    private final String mRuntimeSessionId;
    private final RuntimeIdentity mCaller;
    ...
    public RuntimeToolRequest(String requestId, String runtime, String runtimeSessionId,
            RuntimeIdentity caller, String tool, JSONObject params, String reason,
    ...
    public RuntimeToolRequest(String requestId, String runtime, String runtimeSessionId,
            String phoneSessionId, RuntimeIdentity caller, String tool, JSONObject params,
        ...
        mPhoneSessionId = cleanPhoneSessionId.isEmpty()
                ...
                : cleanPhoneSessionId;
        mCaller = caller == null
                ? new RuntimeIdentity(mRuntime, "", mRuntime) : caller;
        mTool = clean(tool);
        mParams = params == null ? new JSONObject() : copy(params);
        mReason = clean(reason);
        mAutonomy = clean(autonomy);
