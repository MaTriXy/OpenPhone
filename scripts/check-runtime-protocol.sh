...
node "$root/integrations/openclaw-plugin/tests/policy-smoke.mjs"
node "$root/integrations/cli/tests/cli-smoke.mjs"
node "$root/integrations/mcp-server/tests/protocol-smoke.mjs"
